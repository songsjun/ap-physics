  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center p-8 gap-6">
      <div className="text-center">
        <h1 className="text-3xl font-bold text-gray-900">AP Physics 1</h1>
        <p className="text-gray-500 mt-2">自适应学习平台</p>
      </div>
      <div className="flex flex-col gap-3 w-full max-w-xs">
        ...
        <a
          href="/dashboard"
          className="block bg-white hover:bg-gray-50 text-gray-700 text-center py-3 px-6 rounded-xl font-medium border border-gray-200 transition-colors"
        >
          查看进度概览
        </a>
        <a
          href="/settings"
          className="block text-center py-2 text-sm text-gray-400 hover:text-gray-600 transition-colors"
        >
          ⚙ 设置 / 备份进度
        </a>
      </div>
